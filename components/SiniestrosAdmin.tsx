...
export const SiniestrosAdmin: React.FC<SiniestrosAdminProps> = ({ 
    ...
    const unifiedList = useMemo(() => {
        // BLINDAJE DE SEGURIDAD: Evita error 'reading map' si Firebase tarda en responder
                                        ...
                                        editingId === risk.id ? (
                                            ...
                                            <div className="p-4 border-t border-gray-700 bg-gray-900 text-sm space-y-4">
                                                <div className="flex justify-between items-center border-b border-gray-700 pb-2">
                                                    ...
                                                    <button onClick={() => startEdit(risk.id, risk.timestamp, Array.isArray(risk.associatedRouteIds) ? risk.associatedRouteIds[0] : undefined)} className="flex items-center gap-1 text-[10px] bg-gray-700 hover:bg-gray-600 px-2 py-1 rounded text-sky-400"><Edit size={12}/> Editar Fecha/Ruta</button>
                                                </div>
